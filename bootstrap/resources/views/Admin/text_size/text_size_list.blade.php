              ...
              <div class="x_panel">
                <div class="x_title">
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <a href="{{route('create.textsize')}}" class="btn btn-default" style="background: #2A3F54;color:#FFFFFF"> Add message</a>
  ...
  <script>
    ...
    function delete_message(id) {
      if (confirm('Are you sure delete this ?')) {
        ...
        $.ajax({
          type: 'post',
          url: "{{ route('delete.textsize.post') }}",
          data: {
            _token: "{{csrf_token()}}",
            'id': messid
