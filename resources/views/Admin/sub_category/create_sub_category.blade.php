...
@section('title', 'Create card sub category')
...
<div class="">
  <div class="page-title">
    <div class="title_left">
      <h3>Create Card Sub Category</h3>
    </div>
  ...
  @endif
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br />
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('create.sub.category.post',request()->route('subcatid'))}}" enctype="multipart/form-data">
            @csrf
