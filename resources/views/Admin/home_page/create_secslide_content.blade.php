  ...
  @if(Session::has('failed'))
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br />
          <form id="demo-form2" class="form-horizontal form-label-left" method="POST" action="{{ route('create.home.sec.slider.post')}}" enctype="multipart/form-data">
            @csrf
            <div class="row">
            <!-- <div class="col-md-4">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <textarea  name="slide_content"  class="form-control" required></textarea><br>
