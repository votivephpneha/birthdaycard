...
@section('title', 'Create Home First Slider')
    ...
    <div class="">
        <div class="page-title">
            <div class="title_left">
                <h3>Create Home First Slider</h3>
            </div>
        ...
        <div class="row">
            ...
            <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        ...
                        <form id="demo-form2" class="form-horizontal form-label-left" method="POST"
                            action="{{ route('create.home.first.slider.post')}}">
                            @csrf
                            <div class="row">
                                <!-- <div class="col-md-4">
                <div class="form-group">
                    ...
                    <input type="text" id="page_name" name="page_name"
                        class="form-control col-md-7 col-xs-12" value="" required><br>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <textarea id="editor1" name="slide_content_2" class="form-control" rows="10"
                                            cols="80" class="form-control"></textarea><br>
            ...
            <div class="col-md-4">
                <div class="form-group">
                    ...
                    <textarea  name="slide_content_1"  class="form-control" required></textarea><br>
            ...
            <div class="form-group">
                    ...
                    <textarea id="editor2" name="slide_content_3"  class="form-control" ></textarea><br>
                        @if($errors->has('slide_content_2'))
                        <span class="text-danger">{{ $errors->first('slide_content_2')}}</span>
                        @endif
                </div>
                ...
                <div class="form-group">
                    ...
                    <textarea  id="editor3" name="slide_content_4"  class="form-control" ></textarea><br>
                        @if($errors->has('slide_content_2'))
                        <span class="text-danger">{{ $errors->first('slide_content_2')}}</span>
                        @endif
                </div> 
            ...
            <div class="form-group">
                    ...
                    <textarea  id="editor4" name="slide_content_5"  class="form-control" ></textarea><br>
                        @if($errors->has('slide_content_2'))
                        <span class="text-danger">{{ $errors->first('slide_content_2')}}</span>
                        @endif
                </div> 
