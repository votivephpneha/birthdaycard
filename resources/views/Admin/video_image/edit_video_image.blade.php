...
@section('title', 'Edit Video image')
  ...
  @if(Session::has('failed'))
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br />
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('edit.video.image.post',$videoimagedata->id)}}" enctype="multipart/form-data">
            @csrf            
            ...
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">             
                  @if($videoimagedata->editor_image == "")
                  <img src="{{ url('public/images/imageicon.png')}}" height="50" width="50">
                  @else
                  <img src="{{ asset('public/upload/editorImages').'/'. $videoimagedata->editor_image}}" height="50" width="50">
                  @endif
              </div>
            </div>           
            <div class="form-group">
              ...
              <div class="col-md-6 col-sm-6 col-xs-12">
                  <select name="video_image_status" id="video_image_status"  class="form-control">
                    <option value="1"{{ $videoimagedata->status == '1' ? 'selected' : '' }}  >Active</option>
                    <option value="0"{{ $videoimagedata->status == '0' ? 'selected' : '' }}  >Inactive</option>
                  </select>
