...
@section('title', 'Create Editor image')
  ...
  @if(Session::has('failed'))
    ...
    <div class="col-md-12 col-sm-12 col-xs-12">
      <div class="x_panel">
        ...
        <div class="x_content">
          <br />
          <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left" method="POST" action="{{ route('create.editor.image.post')}}" enctype="multipart/form-data">
            @csrf            
