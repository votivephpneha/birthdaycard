        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 col-xs-12">
                ...
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <form id="demo-form2" data-parsley-validate class="form-horizontal form-label-left"
                            method="POST" action="{{route('edit.gift.post',$giftdata->id)}}" enctype="multipart/form-data">
                            @csrf
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="text" id="title" name="title" class="form-control col-md-7 col-xs-12" value="{{$giftdata->card_title}}">
                                    @if($errors->has('title'))
                ...
                @endif
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <input type="number" id="price" name="price"
                                        class="form-control col-md-7 col-xs-12" value="{{$giftdata->price}}">
                                    @if($errors->has('price'))
                                    <span class="text-danger">{{ $errors->first('price')}}</span>
                                    @endif
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-6 col-sm-6 col-xs-12">
                                    <select name="gift_status" id="gift_status" class="form-control">
                                        <option value="1" {{ $giftdata->status == 'Active' ? 'selected' : '' }}>Active</option>
                                        <option value="0" {{ $giftdata->status == 'Inactive' ? 'selected' : '' }}>Inactive</option>
                                    </select>
                            ...
                            @else
                            <img src="{{ asset('public/upload/cards').'/'. $giftdata->card_image}}" height="50" width="50">
                            @endif
